...
FetchHostModel fetchHostModelFromJson(String str) =>
    FetchHostModel.fromJson(json.decode(str));

String fetchHostModelToJson(FetchHostModel data) => json.encode(data.toJson());

class FetchHostModel {
  FetchHostModel({
    bool? status,
    String? message,
    Host? host,
  ...
  FetchHostModel.fromJson(dynamic json) {
    _status = json['status'];
