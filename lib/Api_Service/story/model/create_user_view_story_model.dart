...
CreateUserViewStoryModel createUserViewStoryModelFromJson(String str) => CreateUserViewStoryModel.fromJson(json.decode(str));
String createUserViewStoryModelToJson(CreateUserViewStoryModel data) => json.encode(data.toJson());
class CreateUserViewStoryModel {
  CreateUserViewStoryModel({
      bool? status, 
      String? message, 
      ViewStory? viewStory,}){
    _status = status;
  ...
  CreateUserViewStoryModel.fromJson(dynamic json) {
    _status = json['status'];
...
CreateUserViewStoryModel copyWith({  bool? status,
  String? message,
  ViewStory? viewStory,
}) => CreateUserViewStoryModel(  status: status ?? _status,
