...
HostDebitHistoryModel hostDebitHistoryModelFromJson(String str) => HostDebitHistoryModel.fromJson(json.decode(str));
String hostDebitHistoryModelToJson(HostDebitHistoryModel data) => json.encode(data.toJson());
class HostDebitHistoryModel {
  ...
  HostDebitHistoryModel.fromJson(dynamic json) {
    _status = json['status'];
  ...
  String? _message;
  List<Redeem>? _redeem;
HostDebitHistoryModel copyWith({  bool? status,
  String? message,
  List<Redeem>? redeem,
}) => HostDebitHistoryModel(  status: status ?? _status,
