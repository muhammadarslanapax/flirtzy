...
RedeemRequestModel redeemRequestModelFromJson(String str) => RedeemRequestModel.fromJson(json.decode(str));
String redeemRequestModelToJson(RedeemRequestModel data) => json.encode(data.toJson());
class RedeemRequestModel {
  ...
  RedeemRequestModel.fromJson(dynamic json) {
    _status = json['status'];
  ...
  String? _message;
  List<Redeem>? _redeem;
RedeemRequestModel copyWith({  bool? status,
  String? message,
  List<Redeem>? redeem,
}) => RedeemRequestModel(  status: status ?? _status,
